import { CheckCircle2, Puzzle, Sparkles } from 'lucide-react'
...
export function GameStats({ correctPieces, totalPieces, puzzlesCompleted }: GameStatsProps) {
  const stats = [
    { icon: Puzzle, label: 'Pieces placed', value: `${correctPieces}/${totalPieces}` },
    { icon: CheckCircle2, label: 'Puzzles completed', value: `${puzzlesCompleted}` },
